                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="x_content">
                                    ...
                                    <div class="">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="x_panel">
                                                    <div class="x_content">
                                                        <a data-toggle="modal" data-target="#addUsers"
                                                            class="btn btn-success"><i class="fas fa-plus"></i>
                                                            &nbsp; Add Users</a>
                                                        <p class="text-muted font-13 m-b-30"></p>
                                                        <div class="table-responsive">
                                                            <table style="font-size: 15px" id="dataTable"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="btn-group">
                                                                                <a href="<?= base_url('users/delUsers/' . $show['id']) ?>"
                                                                                    class="btn btn-danger btn-sm tombol-konfirm"
                                                                                    data-judul="Untuk menghapus Kelebihan ?"
                                                                                    data-konfirm="Yakin, Hapus Data !">
                                                                    ...
                                                                    <!-- Modal Edit Users Start -->
                                                                    <div class="modal fade" id="edit<?= $show['id'] ?>"
                                                                        tabindex="-1" role="dialog"
                                                                        aria-labelledby="myModalLabel"
                                                                        aria-hidden="true">
                                                                        <div class="modal-dialog" role="modal">
                                                                            <div class="modal-content">
                                                                                <?= form_open("users/editUsers", array("id" => "form-user", "class" => "form-horizontal")) ?>
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title"
                                                                                        id="demoModalLabel">Edit Users
                                                                                    </h5>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select class="form-control"
                                                                                            ...
                                                                                            <?php foreach ($role as $row) : 
                                                                                                if($row['id']===$show['role_id']) {$selected = 'SELECTED';}else{$selected='';};?>
                                                                                            <option
                                ...
                                <?= form_open("users/addUsers", array("id" => "form-user", "class" => "form-horizontal")) ?>
                                    ...
                                    <div class="modal-dialog" role="modal">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="role">Role Users</label>
