                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="x_content">
                                    ...
                                    <div class="">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="x_panel">
                                                    <div class="x_content">
                                                        <!-- <a data-toggle="modal" data-target="#addRole"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="btn-group">
                                                                                <a href="<?= base_url('users/delRole/' . $show['id']) ?>"
                                                                    ...
                                                                    <div class="modal fade" id="edit<?= $show['id'] ?>"
                                                                        ...
                                                                        <div class="modal-dialog" role="modal">
                                                                            <div class="modal-content">
                                                                                <?= form_open("users/editRole", array("id" => "form-user", "class" => "form-horizontal")) ?>
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title"
                                                                                        id="demoModalLabel">Edit Role
                                                                                    </h5>
                                ...
                                <?= form_open("users/addRole", array("id" => "form-user", "class" => "form-horizontal")) ?>
