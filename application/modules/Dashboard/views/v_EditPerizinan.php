                                                ...
                                                <div class="x_panel">
                                                    <div class="x_content">
                                                        ...
                                                        <div class="table-responsive">
                                                            <?= form_open("Dashboard/ActionEditPerizinan/".$jenisPerizinan[0]['id_perizinan'], array("id" => "form-perizinan", "class" => "form-horizontal")) ?>
                                                            <div class="form-group">
                                                                <label for="name">Name</label>
                                                                <input type="text" id="name" name="name"
                                                                    class="form-control"
                                                                    value="<?= $jenisPerizinan[0]['nama_perizinan'];?>"
                                                                    required>
                                                            </div>
