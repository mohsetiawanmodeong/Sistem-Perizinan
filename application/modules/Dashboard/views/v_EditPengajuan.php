                                                ...
                                                <div class="x_panel">
                                                    <div class="x_content">
                                                        ...
                                                        <div class="table-responsive">
                                                            <?= form_open("Dashboard/ActionEditPengajuan/".$editPengajuan[0]['id_pengajuan'], array("id" => "form-pengajuan", "class" => "form-horizontal")) ?>
                                                            <div class="form-group">
                                                                <label for="perizinan">Jenis Perizinan</label>
                                                                <select class="form-control" id="perizinan"
                                                                    name="perizinan">
                                                                    <?php
                                                                    foreach ($jenisPerizinan as $row) {
                                                                        if($row['id_perizinan'] === $editPengajuan[0]['id_perizinan']){
                                                                            $SELECTED = 'SELECTED';
                                                                        }else{
                                                                            $SELECTED = '';
                                                                        }
                                                                        ;?>
                                                                    <option value="<?= $row['id_perizinan'];?>"
                                                                        <?= $SELECTED ;?>>
                                                                        <?= $row['nama_perizinan'];?>
                                                                    </option>
                                                                    <?php }
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="status" name="status">
                                                                    ...
                                                                    foreach ($status as $row) {
                                                                        if($row['id_status'] === $editPengajuan[0]['id_status']){
                                                                            $SELECTED = 'SELECTED';
                                                                        }else{
                                                                            $SELECTED = '';
                                                                        }
