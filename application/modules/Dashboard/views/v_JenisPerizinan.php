                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="x_content">
                                    ...
                                    <div class="">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="x_panel">
                                                    <div class="x_content">
                                                        <a data-toggle="modal" data-target="#addPerizinan"
                                                            class="btn btn-success"><i class="fas fa-plus"></i>
                                                            &nbsp; Add Jenis Perizinan</a>
                                                        <p class="text-muted font-13 m-b-30"></p>
                                                        <div class="table-responsive">
                                                            <table style="font-size: 15px" id="tablePerizinan"
                                ...
                                <!-- Modal Add Jenis Perizinan Start -->
                                <?= form_open("Dashboard/ActionAddPerizinan", array("id" => "form-user", "class" => "form-horizontal")) ?>
                                <div class="modal fade" id="addPerizinan" tabindex="-1" role="dialog"
                                    aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="modal">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="demoModalLabel">Add Jenis Perizinan</h5>
