                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item"
                                href="<?= base_url('DashboardAdmin/Profuser/' . $this->session->userdata('id')); ?>">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="x_title">
                                    <h2><i class="fa fa-user"></i>&nbsp; Keterangan Decline </h2>
                                </div>
                                <hr>
                                <form action="<?= site_url('DashboardAdmin/ActionDeclinePengajuan/'.$id_pengajuan); ?>"
                                    method="POST" class="form-horizontal form-label-left input_mask">
                                    <div class="col-sm">
                                        <label for="keterangan">Keterangan Di Tolak</label>
