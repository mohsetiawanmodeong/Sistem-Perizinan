...
$(document).ready(function() {
    ...
    $("#tableHistoryPengajuan").DataTable({
        ...
        ajax: {
            url: "DashboardAdmin/jsonHistoryPengajuan",
            type: "POST",
        },
        columns: [{
                data: "id_pengajuan",
            ...
            },
            {
                ...
                render: function(id_pengajuan, type, full, meta) {
                    return (
                        '<a href="DashboardAdmin/LihatDocumentPengajuan/'+id_pengajuan+'" class="btn btn-warning btn-sm" target="_blank"><i class="fa fa-eye"></i> Document </a> <a href="DashboardAdmin/approvePengajuan/' +
                        id_pengajuan +
                        '" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> Setujui</a> <a href="DashboardAdmin/declinePengajuan/' +
                        id_pengajuan +
                        '" class="btn btn-danger btn-sm"><i class="fa fa-pencil"></i> Tolak</a>'
                    );
                },
            },
        ],
